...
namespace IIS.Hfghfghfhhghrh
{
    ...
    [View("ЗаписьE", new string[] {
            ...
            "Кабинет as \'Кабинет\'",
            "Кабинет.НомерКабинета as \'Номер кабинета\'"}, Hidden=new string[] {
            "Сотрудник.Фамилия",
            "Клиент.Фамилия",
    ...
    public class Запись : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Hfghfghfhhghrh.Сотрудник fСотрудник;
        
        private IIS.Hfghfghfhhghrh.Клиент fКлиент;
        
        private IIS.Hfghfghfhhghrh.Кабинет fКабинет;
        ...
        [PropertyStorage(new string[] {
                "Кабинет"})]
        [NotNull()]
        public virtual IIS.Hfghfghfhhghrh.Кабинет Кабинет
        {
            get
            {
                ...
                IIS.Hfghfghfhhghrh.Кабинет result = this.fКабинет;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Hfghfghfhhghrh.Клиент Клиент
        {
            get
            {
                ...
                IIS.Hfghfghfhhghrh.Клиент result = this.fКлиент;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Hfghfghfhhghrh.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Hfghfghfhhghrh.Сотрудник result = this.fСотрудник;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьE", typeof(IIS.Hfghfghfhhghrh.Запись));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаписьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьL", typeof(IIS.Hfghfghfhhghrh.Запись));
                }
            }
        }
    }
